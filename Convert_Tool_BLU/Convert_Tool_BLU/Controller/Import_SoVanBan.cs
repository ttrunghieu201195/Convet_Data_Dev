    ...
    class Import_SoVanBan : Import_Abstract
    {
        ...
        /*protected override void ParseData(DataRow row, Common.VB_TYPE type_vb, DataTable dcm_type)
        {
            ...
            *//*Import_DCM_QUYTAC_NHAYSO import_DCM_QUYTAC_NHAYSO = new Import_DCM_QUYTAC_NHAYSO();
            import_DCM_QUYTAC_NHAYSO.ParseData(dcm_type, dcm_SoVanBan.code);
            Import_DCM_SOVB_TEMPLATESINHSO import_DCM_SOVB_TEMPLATESINHSO = new Import_DCM_SOVB_TEMPLATESINHSO();
            import_DCM_SOVB_TEMPLATESINHSO.ParseData(dcm_type, dcm_SoVanBan.code);*//*
        }*/
        ...
        public void insert_Dcm_SoVanBan(OracleConnection oracleConnection, Configs configs, string query, List<Dcm_SoVanBan> data_list)
        {
            try
            {
                if (data_list.Count > 0)
                {
                    ...
                    Console.WriteLine("Total data to DCM_SOVANBAN: " + data_list.Count);
