...
namespace Convert_Data
{
    class Import_VanBan
    {
        ...
        public List<Dcm_Doc> GetDcm_Docs()
        {
            return dcm_Docs;
        }

        public List<Dcm_Doc_Relation> GetDcm_Doc_Relations()
        {
            return dcm_Doc_Relations;
        }

        public List<Fem_File> GetFem_Files()
        {
            return fem_Files;
        }
        ...
        private void appendToListFileDinhKem(int id_vb, string filesDinhKems)
        {
        ...
        private void appendToListDcmTrack(long doc_id_des, string schema_id_des, long doc_id_sour, string schema_id_sour, DateTime? date_ins)
        {
        ...
        public void insert_Dcm_Doc_Relation (OracleConnection oracleConnection, Configs configs, string query, List<Dcm_Doc_Relation> data_list)
        {
            try
            {
                if (data_list.Count > 0)
        ...
        public void insert_fem_file(OracleConnection oracleConnection, Configs configs, string query, List<Fem_File> data_list)
        {
            try
            {
                if (data_list.Count > 0)
        ...
        public void insert_Dcm_Attach_File(OracleConnection oracleConnection, Configs configs, string query, List<Dcm_Attach_File> data_list)
        {
            try
            {
                if (data_list.Count > 0)
        ...
        public void insert_Dcm_Track(OracleConnection oracleConnection, Configs configs, string query, List<Dcm_Track> data_list)
        {
            try
            {
                if (data_list.Count > 0)
